...
(function (window, undefined) {
    ...
    Uploader.UI.File = {
        ...
        draw: function (task) {
            ...
            var html =
                ...
                '<div class="fr">' +
                    ...
                    '<div class="u-op" style="display: none">' +
        ...
        update: function (task) {
            ...
            if(total==0){
                setHtml(boxState, Uploader.getStatusText(-3));

                //上传速度;
                var speed = task.avgSpeed || task.speed;
                setHtml(boxSpeed, "0kb/s");

                //已上传的文件大小
                var html_size1 = '<span class="u-loaded">0kb</span>/';
                //文件总大小
                html_size1 += '<span class="u-total">0kb</span>';

                setHtml(boxSize, html_size1);
                return;
            }else {
                //更新任务状态
