...
public class DiffMatchPatchUtil {
     ...
     */
    public static float Diff_Timeout = 1.0f;
    /**
     ...
     */
    public static short Diff_DualThreshold = 32;
    /**
     ...
     * @return Linked List of Diff objects.
     */
    protected static LinkedList<Diff> diff_compute(String text1, String text2, boolean checklines) {
     ...
     */
    protected static LinesToCharsResult diff_linesToChars(String text1, String text2) {
     ...
     * @param lineArray List of unique strings.
     */
    protected static void diff_charsToLines(LinkedList<Diff> diffs, List<String> lineArray) {
        StringBuilder text;
        for (Diff diff : diffs) {
     ...
     */
    protected static LinkedList<Diff> diff_map(String text1, String text2) {
     ...
     */
    protected static LinkedList<Diff> diff_path1(List<Set<Long>> v_map, String text1, String text2) {
     ...
     * @return LinkedList of Diff objects.
     */
    protected static LinkedList<Diff> diff_path2(List<Set<Long>> v_map, String text1, String text2) {
        LinkedList<Diff> path = new LinkedList<Diff>();
        int x = text1.length();
        int y = text2.length();
        Operation last_op = null;
     ...
     * @param diffs LinkedList of Diff objects.
     */
    public static void diff_cleanupSemantic(LinkedList<Diff> diffs) {
        if (diffs.isEmpty()) {
            return;
        }
     ...
     * @param diffs LinkedList of Diff objects.
     */
    public static void diff_cleanupSemanticLossless(LinkedList<Diff> diffs) {
    ...
    private static Pattern BLANKLINEEND
            = Pattern.compile("\\n\\r?\\n\\Z", Pattern.DOTALL);
    private static Pattern BLANKLINESTART
            = Pattern.compile("\\A\\r?\\n\\r?\\n", Pattern.DOTALL);
    /**
    ...
    public static String getHtmlDiffString(String text1,String text2){
        return diff_prettyHtml(diff_main(text1,text2));
    }

    public static void main(String[] args){
        String file1 = "C:\\Users\\dongao\\Desktop\\index.shtml";
        //String file1 = "http://ei-d-files.dongao.com/ei-dongao/image/common/2019/index.shtml";
        String text1 = getFileString2(file1);
        String file2 = "C:\\Users\\dongao\\Desktop\\index-new.shtml";
        String text2 = getFileString2(file2);
        String filename = file1.substring(file1.lastIndexOf("\\")+1,file1.length());
        String htmlDiffString = DiffMatchPatchUtil.getHtmlDiffString(text1, text2);
        //htmlDiffString.replace("¶","");
        getResultFile2(htmlDiffString,filename);
    }
    ...
    public static String getFileString2(String filePath) {
        String res = null;
        try {
            File file = new File(filePath);
            Document document = Jsoup.parse(file, "UTF-8");
            res = document.body().html();
        }catch (Exception e) {
            e.printStackTrace();
        }
        return res;
    ...
    public static String getResultFile(String fileContent, String filename) {
        //System.out.println(fileContent);
        BufferedWriter out = null;
        try {
            //路径
            String filePath = ConfigConstant.cosTempPath;
            File pathFile = new File(filePath);
            if (!pathFile.exists()) {
                pathFile.mkdirs();
            }
            String relFilePath = filePath + "new_" + filename;
    ...
    public static String getResultFile2(String fileContent,String filename) {
        Document parse = Jsoup.parse(fileContent);
        fileContent = parse.toString();
        //System.out.println(fileContent);
        BufferedWriter out = null;
        try {
            //路径
