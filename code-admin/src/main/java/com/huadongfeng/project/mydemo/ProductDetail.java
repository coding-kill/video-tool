 ...
 *
 */
@Gecco(matchUrl="https://www.dongao.com/dy/zckjs_sj_43343/{id}.shtml", pipelines={"consolePipeline", "myProductDetailPipeline"})
...
//	private List<HrefBean> details;
	 ...
	 */
	@Html
	@HtmlField(cssPath="body > div.wrap.clearfix > div.main_left > div.answer_detail > div.detail_bot > div.answer_content")
